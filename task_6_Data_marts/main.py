"""
Data mart for student activity and performance analytics.

The script creates schema dmr and refreshes the table
dmr.analytics_student_performance from public.user_logs and public.departments.
"""
...
def get_db_config():
    ...
    return {
        ...
        "database": os.getenv("DB", os.getenv("DB_NAME", "educational_portal")),
...
def create_schema(conn):
    """Create dmr schema if it does not exist."""
...
def create_table(conn):
    """Create analytics_student_performance data mart table."""
    query = """
...
def refresh_data_mart(conn):
    """Populate dmr.analytics_student_performance with aggregated student data."""
    query = """
...
def main():
    """Run all data mart creation steps."""
    conn = None
    try:
        conn = get_connection()
        create_schema(conn)
